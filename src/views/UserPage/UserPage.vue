...
import { HeartN, HeartFillN, Message } from "@nutui/icons-vue";
...
const getUserInfo = async () => {
  const result = await getOtherUserInfoService(route.query.id);
  if (result.code === 0) {
...
<template>
  <div class="header">
    ...
    <div
      class="introduction"
      v-if="userInfo.introduction !== null && userInfo.introduction !== ''"
    >
    ...
    <div class="data-follow">
      ...
      <div class="follow">
        <!-- <nut-button color="var(--theme-color-red)" size="small"
          >关注</nut-button
        >
